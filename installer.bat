...
if %errorlevel% equ 0 (
    echo Python esta instalado. Python is installed.
) else (
    echo Python no esta instalado. Python is not installed.
    ...
    echo Python se ha instalado correctamente. Python is sucefully installed.
)
rem Comprobar si FFmpeg está instalado
ffmpeg -version >nul 2>&1
if %errorlevel% equ 0 (
    echo FFmpeg esta instalado. FFmpeg is installed.
) else (
    echo FFmpeg no esta instalado. FFmpeg is not installed.
    rem Instalar FFmpeg desde winget
    winget install FFmpeg
    echo FFmpeg se ha instalado correctamente. FFmpeg is sucefully installed.
)
rem
